	...
	*config::value_as_string_default("ArtificialViscosity", "SN"))) {
	...
	if (!particle_gas_drag_enabled) {
	    logging::print_master(LOG_ERROR
				  "Do not use semi-implicit particle "
	...
	if (!particle_gas_drag_enabled) {
		...
		LOG_ERROR "Do not use implicit particle integrator without "
	...
	logging::print_master(LOG_ERROR
			      "Cannot enable particle_disk_gravity_enabled "
	...
	logging::print_master(LOG_WARNING
			      "particle_minimum_escape_radius can't be "
	...
	logging::print_master(LOG_WARNING
			      "particle_maximum_escape_radius can't be "
...
void summarize_parameters()
{
	...
	logging::print_master(LOG_INFO "Using Tscharnuter-Winkler (1979) "
	...
	logging::print_master(LOG_INFO "Using Stone-Norman (1991, ZEUS-2D) "
				       "artificial viscosity with C = %lf.\n",
			      parameters::artificial_viscosity_factor);
	logging::print_master(
	    LOG_INFO "Artificial viscosity is %s for dissipation.\n",
	...
	logging::print_master(LOG_INFO "Using 'reflecting boundary condition' "
				       "at inner boundary.\n");
	break;
    case boundary_condition_nonreflecting:
	logging::print_master(LOG_INFO "Using 'nonreflecting boundary "
				       "condition' at inner boundary.\n");
	break;
    case boundary_condition_evanescent:
	logging::print_master(LOG_INFO "Using 'evanescent boundary condition' "
				       "at inner boundary.\n");
	break;
    case boundary_condition_viscous_outflow:
	logging::print_master(LOG_INFO "Using 'viscous outflow boundary "
				       "condition' at inner boundary.\n");
	break;
    case boundary_condition_boundary_layer:
	logging::print_master(LOG_INFO "Using 'boundary layer boundary "
				       "conditions' at inner boundary.\n");
	break;
    case boundary_condition_keplerian:
	logging::print_master(LOG_INFO "Using 'keplarian boundary conditions' "
				       "at inner boundary.\n");
	break;
    }
	...
	logging::print_master(LOG_INFO "Boundary Layer: Radial velocity at "
				       "inner boundary is %e * V_Kepler.\n",
			      vrad_fraction_of_kepler);
	logging::print_master(LOG_INFO "Boundary Layer: Stellar rotation rate "
				       "is %f * Om_Kepler.\n",
			      stellar_rotation_rate);
    }
	...
	logging::print_master(LOG_INFO "Kramers opacity and constant electron "
	...
	logging::print_master(
	    LOG_INFO "Distributing particles with a r^%.2g profile from %g to "
	...
	case integrator_adaptive:
	    logging::print_master(LOG_INFO "Particles use the (explicit) "
					   "adaptive integrator\n");
	    break;
