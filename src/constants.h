...
// overlap cells (Zeus-like overlap kernel. 2:transport; 2: source, 1:viscous stress)
...
// _G and _R are always defined with _ and are linked to G and R with compilied without NDEBUG otherswise to const double 1
#ifndef NDEBUG
extern t_constant &G ;
extern t_constant &R;
#else
