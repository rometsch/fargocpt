...
struct force {
    ...
    /// sphere avoidance
    double fy_inner;
    /// x-component of the force arising from the inner disk, with Hill sphere
    /// avoidance
    double fx_ex_inner;
    /// y-component of the force arising from the inner disk, with Hill sphere
    /// avoidance
    double fy_ex_inner;
    ...
    /// sphere avoidance
    double fy_outer;
    /// x-component of the force arising from the outer disk, with Hill sphere
    /// avoidance
    double fx_ex_outer;
    /// x-component of the force arising from the outer disk, with Hill sphere
    /// avoidance
