...
/**
 * @brief update_sg_constants, calculate mass weighted aspect ratio and use it to update lambda_sq and chi_sq.
 * see Moldenhauer 2018 for more info on the constants or Baruteau, 2008 for info on the self gravity module.
 * @param data
 */
